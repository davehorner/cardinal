pub mod cardinal_orcas_symbols {
    ...
    pub fn get_slice<'a>(ram: &'a [u8], label: &str) -> Option<&'a [u8]> {
        match label {
            ...
            "System/expansion" => Some(&ram[_cSYSTEM_EXPANSION.._cSYSTEM_EXPANSION+_cSYSTEM_EXPANSION_SIZE]),
            ...
            "System/metadata" => Some(&ram[_cSYSTEM_METADATA.._cSYSTEM_METADATA+_cSYSTEM_METADATA_SIZE]),
            ...
            "Console/vector" => Some(&ram[_cCONSOLE_VECTOR.._cCONSOLE_VECTOR+_cCONSOLE_VECTOR_SIZE]),
            ...
            "Controller/vector" => Some(&ram[_cCONTROLLER_VECTOR.._cCONTROLLER_VECTOR+_cCONTROLLER_VECTOR_SIZE]),
            "Controller/button" => Some(&ram[_cCONTROLLER_BUTTON.._cCONTROLLER_BUTTON+_cCONTROLLER_BUTTON_SIZE]),
            "Controller/key" => Some(&ram[_cCONTROLLER_KEY.._cCONTROLLER_KEY+_cCONTROLLER_KEY_SIZE]),
            ...
            "Mouse/scrolly-hb" => Some(&ram[_cMOUSE_SCROLLY_HB.._cMOUSE_SCROLLY_HB+_cMOUSE_SCROLLY_HB_SIZE]),
            "Mouse/scrolly-lb" => Some(&ram[_cMOUSE_SCROLLY_LB.._cMOUSE_SCROLLY_LB+_cMOUSE_SCROLLY_LB_SIZE]),
            ...
            "File/success-lb" => Some(&ram[_cFILE_SUCCESS_LB.._cFILE_SUCCESS_LB+_cFILE_SUCCESS_LB_SIZE]),
            ...
            "DateTime/month" => Some(&ram[_cDATETIME_MONTH.._cDATETIME_MONTH+_cDATETIME_MONTH_SIZE]),
            ...
            "DateTime/minute" => Some(&ram[_cDATETIME_MINUTE.._cDATETIME_MINUTE+_cDATETIME_MINUTE_SIZE]),
            "DateTime/second" => Some(&ram[_cDATETIME_SECOND.._cDATETIME_SECOND+_cDATETIME_SECOND_SIZE]),
            ...
            "DateTime/isdst" => Some(&ram[_cDATETIME_ISDST.._cDATETIME_ISDST+_cDATETIME_ISDST_SIZE]),
            "Types/lock-default" => Some(&ram[_cTYPES_LOCK_DEFAULT.._cTYPES_LOCK_DEFAULT+_cTYPES_LOCK_DEFAULT_SIZE]),
            "Types/lock-lut" => Some(&ram[_cTYPES_LOCK_LUT.._cTYPES_LOCK_LUT+_cTYPES_LOCK_LUT_SIZE]),
            "Types/lock-right" => Some(&ram[_cTYPES_LOCK_RIGHT.._cTYPES_LOCK_RIGHT+_cTYPES_LOCK_RIGHT_SIZE]),
            "Types/lock-output" => Some(&ram[_cTYPES_LOCK_OUTPUT.._cTYPES_LOCK_OUTPUT+_cTYPES_LOCK_OUTPUT_SIZE]),
            ...
            "Styles/selected" => Some(&ram[_cSTYLES_SELECTED.._cSTYLES_SELECTED+_cSTYLES_SELECTED_SIZE]),
            ...
            "timer/frame-lb" => Some(&ram[_cTIMER_FRAME_LB.._cTIMER_FRAME_LB+_cTIMER_FRAME_LB_SIZE]),
            ...
            "src/on-console" => Some(&ram[_cSRC_ON_CONSOLE.._cSRC_ON_CONSOLE+_cSRC_ON_CONSOLE_SIZE]),
            ...
            "src/<unchange>" => Some(&ram[_cSRC__UNCHANGE_.._cSRC__UNCHANGE_+_cSRC__UNCHANGE__SIZE]),
            "src/<change>" => Some(&ram[_cSRC__CHANGE_.._cSRC__CHANGE_+_cSRC__CHANGE__SIZE]),
            "src/<set-change>" => Some(&ram[_cSRC__SET_CHANGE_.._cSRC__SET_CHANGE_+_cSRC__SET_CHANGE__SIZE]),
            "src/last" => Some(&ram[_cSRC_LAST.._cSRC_LAST+_cSRC_LAST_SIZE]),
            "src/<force-change>" => Some(&ram[_cSRC__FORCE_CHANGE_.._cSRC__FORCE_CHANGE_+_cSRC__FORCE_CHANGE__SIZE]),
            ...
            "src/default-path" => Some(&ram[_cSRC_DEFAULT_PATH.._cSRC_DEFAULT_PATH+_cSRC_DEFAULT_PATH_SIZE]),
            "on-button" => Some(&ram[_cON_BUTTON.._cON_BUTTON+_cON_BUTTON_SIZE]),
            "λ0b" => Some(&ram[_c_0B.._c_0B+_c_0B_SIZE]),
            "on-button-arrow" => Some(&ram[_cON_BUTTON_ARROW.._cON_BUTTON_ARROW+_cON_BUTTON_ARROW_SIZE]),
            "on-button-arrow/x" => Some(&ram[_cON_BUTTON_ARROW_X.._cON_BUTTON_ARROW_X+_cON_BUTTON_ARROW_X_SIZE]),
            "on-button-arrow/y" => Some(&ram[_cON_BUTTON_ARROW_Y.._cON_BUTTON_ARROW_Y+_cON_BUTTON_ARROW_Y_SIZE]),
            "on-button-arrow/mod" => Some(&ram[_cON_BUTTON_ARROW_MOD.._cON_BUTTON_ARROW_MOD+_cON_BUTTON_ARROW_MOD_SIZE]),
            "on-button-arrow/vec" => Some(&ram[_cON_BUTTON_ARROW_VEC.._cON_BUTTON_ARROW_VEC+_cON_BUTTON_ARROW_VEC_SIZE]),
            ...
            "variables/<pull>" => Some(&ram[_cVARIABLES__PULL_.._cVARIABLES__PULL_+_cVARIABLES__PULL__SIZE]),
            "λ0f" => Some(&ram[_c_0F.._c_0F+_c_0F_SIZE]),
            "variables/<commit>" => Some(&ram[_cVARIABLES__COMMIT_.._cVARIABLES__COMMIT_+_cVARIABLES__COMMIT__SIZE]),
            "λ10" => Some(&ram[_c_10.._c_10+_c_10_SIZE]),
            "variables/<reset>" => Some(&ram[_cVARIABLES__RESET_.._cVARIABLES__RESET_+_cVARIABLES__RESET__SIZE]),
            ...
            "grid/<reqdraw>" => Some(&ram[_cGRID__REQDRAW_.._cGRID__REQDRAW_+_cGRID__REQDRAW__SIZE]),
            "grid/<try-draw>" => Some(&ram[_cGRID__TRY_DRAW_.._cGRID__TRY_DRAW_+_cGRID__TRY_DRAW__SIZE]),
            ...
            "grid/<draw-cell>" => Some(&ram[_cGRID__DRAW_CELL_.._cGRID__DRAW_CELL_+_cGRID__DRAW_CELL__SIZE]),
            "grid/<draw-cell-lowercase>" => Some(&ram[_cGRID__DRAW_CELL_LOWERCASE_.._cGRID__DRAW_CELL_LOWERCASE_+_cGRID__DRAW_CELL_LOWERCASE__SIZE]),
            "grid/highlight" => Some(&ram[_cGRID_HIGHLIGHT.._cGRID_HIGHLIGHT+_cGRID_HIGHLIGHT_SIZE]),
            "grid/<draw-cell-grid>" => Some(&ram[_cGRID__DRAW_CELL_GRID_.._cGRID__DRAW_CELL_GRID_+_cGRID__DRAW_CELL_GRID__SIZE]),
            "λ13" => Some(&ram[_c_13.._c_13+_c_13_SIZE]),
            "grid/<draw-cell-port>" => Some(&ram[_cGRID__DRAW_CELL_PORT_.._cGRID__DRAW_CELL_PORT_+_cGRID__DRAW_CELL_PORT__SIZE]),
            "grid/<draw-cell-selected>" => Some(&ram[_cGRID__DRAW_CELL_SELECTED_.._cGRID__DRAW_CELL_SELECTED_+_cGRID__DRAW_CELL_SELECTED__SIZE]),
            ...
            "voices/<release>" => Some(&ram[_cVOICES__RELEASE_.._cVOICES__RELEASE_+_cVOICES__RELEASE__SIZE]),
            "voices/<add>" => Some(&ram[_cVOICES__ADD_.._cVOICES__ADD_+_cVOICES__ADD__SIZE]),
            "λ18" => Some(&ram[_c_18.._c_18+_c_18_SIZE]),
            "voices/<update>" => Some(&ram[_cVOICES__UPDATE_.._cVOICES__UPDATE_+_cVOICES__UPDATE__SIZE]),
            ...
            "font/<draw-short>" => Some(&ram[_cFONT__DRAW_SHORT_.._cFONT__DRAW_SHORT_+_cFONT__DRAW_SHORT__SIZE]),
            "font/<draw-byte>" => Some(&ram[_cFONT__DRAW_BYTE_.._cFONT__DRAW_BYTE_+_cFONT__DRAW_BYTE__SIZE]),
            "font/<draw-hex>" => Some(&ram[_cFONT__DRAW_HEX_.._cFONT__DRAW_HEX_+_cFONT__DRAW_HEX__SIZE]),
            "font/<draw-char-color>" => Some(&ram[_cFONT__DRAW_CHAR_COLOR_.._cFONT__DRAW_CHAR_COLOR_+_cFONT__DRAW_CHAR_COLOR__SIZE]),
            "font/<draw-char>" => Some(&ram[_cFONT__DRAW_CHAR_.._cFONT__DRAW_CHAR_+_cFONT__DRAW_CHAR__SIZE]),
            "font/color" => Some(&ram[_cFONT_COLOR.._cFONT_COLOR+_cFONT_COLOR_SIZE]),
            "font/<draw-str>" => Some(&ram[_cFONT__DRAW_STR_.._cFONT__DRAW_STR_+_cFONT__DRAW_STR__SIZE]),
            "font/>while" => Some(&ram[_cFONT__WHILE.._cFONT__WHILE+_cFONT__WHILE_SIZE]),
            "λ1c" => Some(&ram[_c_1C.._c_1C+_c_1C_SIZE]),
            "ports/get-right1-val" => Some(&ram[_cPORTS_GET_RIGHT1_VAL.._cPORTS_GET_RIGHT1_VAL+_cPORTS_GET_RIGHT1_VAL_SIZE]),
            "ports/get-right-val" => Some(&ram[_cPORTS_GET_RIGHT_VAL.._cPORTS_GET_RIGHT_VAL+_cPORTS_GET_RIGHT_VAL_SIZE]),
            "ports/get-left1-val" => Some(&ram[_cPORTS_GET_LEFT1_VAL.._cPORTS_GET_LEFT1_VAL+_cPORTS_GET_LEFT1_VAL_SIZE]),
            "ports/get-left-val" => Some(&ram[_cPORTS_GET_LEFT_VAL.._cPORTS_GET_LEFT_VAL+_cPORTS_GET_LEFT_VAL_SIZE]),
            "ports/get-left1-raw" => Some(&ram[_cPORTS_GET_LEFT1_RAW.._cPORTS_GET_LEFT1_RAW+_cPORTS_GET_LEFT1_RAW_SIZE]),
            "ports/get-left-raw" => Some(&ram[_cPORTS_GET_LEFT_RAW.._cPORTS_GET_LEFT_RAW+_cPORTS_GET_LEFT_RAW_SIZE]),
            "ports/get-right1-case" => Some(&ram[_cPORTS_GET_RIGHT1_CASE.._cPORTS_GET_RIGHT1_CASE+_cPORTS_GET_RIGHT1_CASE_SIZE]),
            "ports/get-right1-raw" => Some(&ram[_cPORTS_GET_RIGHT1_RAW.._cPORTS_GET_RIGHT1_RAW+_cPORTS_GET_RIGHT1_RAW_SIZE]),
            "ports/get-right-raw" => Some(&ram[_cPORTS_GET_RIGHT_RAW.._cPORTS_GET_RIGHT_RAW+_cPORTS_GET_RIGHT_RAW_SIZE]),
            "ports/<set-output-below>" => Some(&ram[_cPORTS__SET_OUTPUT_BELOW_.._cPORTS__SET_OUTPUT_BELOW_+_cPORTS__SET_OUTPUT_BELOW__SIZE]),
            "ports/<set-output>" => Some(&ram[_cPORTS__SET_OUTPUT_.._cPORTS__SET_OUTPUT_+_cPORTS__SET_OUTPUT__SIZE]),
            "ports/<set-raw>" => Some(&ram[_cPORTS__SET_RAW_.._cPORTS__SET_RAW_+_cPORTS__SET_RAW__SIZE]),
            "ports/<set-lock>" => Some(&ram[_cPORTS__SET_LOCK_.._cPORTS__SET_LOCK_+_cPORTS__SET_LOCK__SIZE]),
            ...
            "edit/<toggle-comment>" => Some(&ram[_cEDIT__TOGGLE_COMMENT_.._cEDIT__TOGGLE_COMMENT_+_cEDIT__TOGGLE_COMMENT__SIZE]),
            ...
            "timer/on-pause" => Some(&ram[_cTIMER_ON_PAUSE.._cTIMER_ON_PAUSE+_cTIMER_ON_PAUSE_SIZE]),
            "timer/f" => Some(&ram[_cTIMER_F.._cTIMER_F+_cTIMER_F_SIZE]),
            "λ22" => Some(&ram[_c_22.._c_22+_c_22_SIZE]),
            "timer/<toggle>" => Some(&ram[_cTIMER__TOGGLE_.._cTIMER__TOGGLE_+_cTIMER__TOGGLE__SIZE]),
            ...
            "timer/widget/<draw>" => Some(&ram[_cTIMER_WIDGET__DRAW_.._cTIMER_WIDGET__DRAW_+_cTIMER_WIDGET__DRAW__SIZE]),
            "timer/widget/x" => Some(&ram[_cTIMER_WIDGET_X.._cTIMER_WIDGET_X+_cTIMER_WIDGET_X_SIZE]),
            "timer/widget/y" => Some(&ram[_cTIMER_WIDGET_Y.._cTIMER_WIDGET_Y+_cTIMER_WIDGET_Y_SIZE]),
            ...
            "select/validate-from" => Some(&ram[_cSELECT_VALIDATE_FROM.._cSELECT_VALIDATE_FROM+_cSELECT_VALIDATE_FROM_SIZE]),
            "select/validate-to" => Some(&ram[_cSELECT_VALIDATE_TO.._cSELECT_VALIDATE_TO+_cSELECT_VALIDATE_TO_SIZE]),
            "select/is-within" => Some(&ram[_cSELECT_IS_WITHIN.._cSELECT_IS_WITHIN+_cSELECT_IS_WITHIN_SIZE]),
            "select/outside" => Some(&ram[_cSELECT_OUTSIDE.._cSELECT_OUTSIDE+_cSELECT_OUTSIDE_SIZE]),
            "select/<reset>" => Some(&ram[_cSELECT__RESET_.._cSELECT__RESET_+_cSELECT__RESET__SIZE]),
            ...
            "select/<range>" => Some(&ram[_cSELECT__RANGE_.._cSELECT__RANGE_+_cSELECT__RANGE__SIZE]),
            ...
            "select/widget/<draw>" => Some(&ram[_cSELECT_WIDGET__DRAW_.._cSELECT_WIDGET__DRAW_+_cSELECT_WIDGET__DRAW__SIZE]),
            "select/widget/x" => Some(&ram[_cSELECT_WIDGET_X.._cSELECT_WIDGET_X+_cSELECT_WIDGET_X_SIZE]),
            "select/widget/y" => Some(&ram[_cSELECT_WIDGET_Y.._cSELECT_WIDGET_Y+_cSELECT_WIDGET_Y_SIZE]),
            "λ34" => Some(&ram[_c_34.._c_34+_c_34_SIZE]),
            "insert/<toggle>" => Some(&ram[_cINSERT__TOGGLE_.._cINSERT__TOGGLE_+_cINSERT__TOGGLE__SIZE]),
            "insert/on-button" => Some(&ram[_cINSERT_ON_BUTTON.._cINSERT_ON_BUTTON+_cINSERT_ON_BUTTON_SIZE]),
            ...
            "cursor/<update>" => Some(&ram[_cCURSOR__UPDATE_.._cCURSOR__UPDATE_+_cCURSOR__UPDATE__SIZE]),
            ...
            "cursor/sprite-icn" => Some(&ram[_cCURSOR_SPRITE_ICN.._cCURSOR_SPRITE_ICN+_cCURSOR_SPRITE_ICN_SIZE]),
            "random/<init>" => Some(&ram[_cRANDOM__INIT_.._cRANDOM__INIT_+_cRANDOM__INIT__SIZE]),
            "random/generate" => Some(&ram[_cRANDOM_GENERATE.._cRANDOM_GENERATE+_cRANDOM_GENERATE_SIZE]),
            ...
            "chrvel/has-vel" => Some(&ram[_cCHRVEL_HAS_VEL.._cCHRVEL_HAS_VEL+_cCHRVEL_HAS_VEL_SIZE]),
            "chrvel/silence" => Some(&ram[_cCHRVEL_SILENCE.._cCHRVEL_SILENCE+_cCHRVEL_SILENCE_SIZE]),
            ...
            "op-self/<push>" => Some(&ram[_cOP_SELF__PUSH_.._cOP_SELF__PUSH_+_cOP_SELF__PUSH__SIZE]),
