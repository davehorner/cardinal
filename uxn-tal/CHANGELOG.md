...
- *(spawn)* stop waiting for emu, spawn. hide git console window on windows

## [0.7.1](https://github.com/davehorner/cardinal/compare/uxn-tal-v0.7.0...uxn-tal-v0.7.1) - 2025-11-02

### Fixed

- *(@git)* fix url_git to preserve http(s)
